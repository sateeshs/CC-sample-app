...
description: "React and Next.js 16+ application development with App Router, Server Components, TypeScript, Tailwind CSS, and modern frontend patterns."
source: personal
risk: safe
...
Specialized workflow for building React and Next.js 16+ applications with modern patterns including App Router, Server Components, TypeScript, and Tailwind CSS.

## When to Use This Workflow

Use this workflow when:
- Building new React applications
- Creating Next.js 16+ projects with App Router
...
- `nextjs-app-router-patterns` - Next.js 16+ patterns
...
#### Copy-Paste Prompts
```
Use @app-builder to scaffold a new Next.js 16 project with App Router
```
