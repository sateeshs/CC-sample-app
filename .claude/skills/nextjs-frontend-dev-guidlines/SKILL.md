...
Description: Front-end development guidelines for Next.js 15 applications. Modern patterns with React 19, TypeScript, Shadcn/ui, Tailwind CSS. Includes Server Components, Client Components, App Router, File Structure, Shadcn/ui Components, Performance Optimization, and TypeScript Best Practices. Used to create components, pages, features, fetch data, style, route, and work with front-end code.
---
